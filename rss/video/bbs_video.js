...
function switch_server_line(art, item) {
    java.log(`线路切换至：${item.html}  ${item.value}`)
    art.switchUrl(item.value)
    art.notice.show = item.html
}

function server_line_init(art, urls) {
